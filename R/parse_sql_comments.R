...
#'
#' This function is used to parse comments from sql statments. It removes something like /* coments*/ or
#' --. But it won't work if there is something like select * from tname where x = '--test'.
